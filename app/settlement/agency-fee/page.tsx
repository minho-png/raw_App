      ...
      <main className="p-6 space-y-6">
        ...
        {!motivProduct && (
          <div className="rounded-lg border border-emerald-200 bg-emerald-50/60 px-4 py-2.5 text-[11px] text-emerald-900 flex items-center gap-2">
            ...
            <span>
              <strong>CT/CTV 대행사 공식 정산값(Open API)</strong>은 product 필터를 <strong>&apos;CT&apos;</strong>, <strong>&apos;CTV&apos;</strong>, 또는 <strong>&apos;ALL&apos;</strong> 로 선택하면 표시됩니다.
            </span>
          </div>
        )}
          ...
          return (
            <div className="rounded-xl border border-gray-200 bg-white overflow-hidden">
              <div className="flex items-center justify-between gap-3 px-5 py-3.5 border-b border-gray-100 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  <SnapshotActions snapshot={agencySnapshot} liveRows={agencySettlement.rows} excelFilename={`agency-fee_${month}`} />
                </div>
              </div>
