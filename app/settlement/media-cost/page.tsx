...
// 대행사 색상 팔레트는 lib/colorPalettes.ts 의 단일 source 사용 (settlement/agency-fee 와 공유)
      ...
      <main className="p-6 space-y-6">
        ...
        {!motivProduct && (
          <div className="rounded-lg border border-emerald-200 bg-emerald-50/60 px-4 py-2.5 text-[11px] text-emerald-900 flex items-center gap-2">
            ...
            <span>
              <strong>CT/CTV 매체별 공식 정산값(Open API)</strong>은 product 필터를 <strong>&apos;CT&apos;</strong>, <strong>&apos;CTV&apos;</strong>, 또는 <strong>&apos;ALL&apos;</strong> 로 선택하면 표시됩니다.
            </span>
          </div>
        )}
